...
<body>
    <form id="form1" runat="server">
                ...
                <asp:GridView ID="TeamsGridView" runat="server" AutoGenerateColumns="false" OnRowCommand="TeamsGridView_RowCommand">
                    <Columns>
                        ...
                        <asp:TemplateField ShowHeader="false">
                            <ItemTemplate>
                                <asp:Button ID="EditButton" Text="Edit" runat="server" CommandName="EditTeam" CommandArgument="<%# Container.DataItemIndex %>" />
                                <asp:Button ID="DeleteButton" Text="Delete" runat="server" CommandName="DeleteTeam" CommandArgument="<%# Container.DataItemIndex %>" />
                            </ItemTemplate>
                        </asp:TemplateField>
        ...
        <div class="footer">
            <span style="float:left; text-align:left;">How to use: <a href="/Resources/OCDP-Manual.pdf" target="_blank" style="color:gray;">Manual</a></span>
